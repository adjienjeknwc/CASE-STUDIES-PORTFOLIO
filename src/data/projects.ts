...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  {
    id: "duolingo",
    title: "Conquering the B2 Intermediate Plateau on Duolingo",
    subtitle: "AI Voice Micro-Missions & Co-Op Guild Streaks driving D90 retention & LTV expansion",
    category: "GROWTH",
    type: "Metric-First Product Case Study",
    role: "Product Manager (Case Study)",
    focusMetric: "D90 Active Retention (+28.4%) & Super Conversion (+34.2%)",
    summary: "How Duolingo can solve the 62% intermediate user drop-off between Day 30 and 90 by introducing AI Voice Roleplays, Co-Op Guild Rescue Streaks, and Lockscreen ambient flash-scenarios.",
    tags: ["EdTech", "Retention Strategy", "GenAI Voice", "Co-Op Streaks", "Product Strategy"],
  ...
  {
    id: "ev",
    title: "Eliminating Range Anxiety in Inter-City EV Travel",
    subtitle: "MakeMyTrip x Grid-Lock Integration — Real-time telemetry, charger pre-booking & hotel bundling",
    category: "STRATEGY",
    type: "Strategic Product Integration",
    role: "Product Manager (Case Study)",
    focusMetric: "Inter-City EV Trip Completions & Booking Conversion (+18%)",
    summary: "How MakeMyTrip can capture the high-value EV traveler segment by embedding Grid-Lock's real-time telemetry API for pre-booked charging slots and EV-friendly hotel bundling.",
    tags: ["TravelTech", "EV Mobility", "API Telemetry", "Grid-Lock", "Outstation Travel"],
