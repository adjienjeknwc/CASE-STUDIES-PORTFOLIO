...
Personal Details (Full name, DOB, demographics)
Contact Information (Email, Phone, address alignment)
Financial Details (Annual income, employment, ID checks)
Insurance Parameters (Plan type, Sum Assured, payment frequency)
Document Uploads (PAN Card, Aadhaar Card, Income Proof)
Final Review & Compliance declaration
...
<ADDITIONAL_METADATA>
The current local time is: 2026-07-25T03:30:52+05:30.
</ADDITIONAL_METADATA>