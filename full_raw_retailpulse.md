<USER_REQUEST>
JD -JOB DESCRIPTION
Company Website: www.huskpowersystems.com
Position Name: Program Manager
Division/Function:
Reporting To: Business Head-BEEM
Location: Mumbai
About Husk
Husk Power Systems (“Husk”) is an award-winning climate-resilient company serving rural India and Sub-Saharan
Africa. In 2023, it was named “World’s Best Challenger Brand” in the energy industry and is a 3-time Global
Cleantech 100 company. The CEO has been recognized by TIME magazine as one of the 100 climate leaders in the
world. The company’s AI-powered platform provides 24/7 clean, renewable power to rural households,
commercial customers, institutions and small factories. It also delivers a range of other products and services,
including e-commerce and credit-financing of branded appliances for home and commercial use, as well as
community-based solutions for e-mobility and the agricultural value chain. Husk’s mission is "Powering Rural
Prosperity", driving economic growth and social wellbeing in rural communities while also nurturing the planet by
deploying low-carbon technology.
Benefits:
Husk offers flexible working conditions with employee benefits that align with global best practices. These include
clear career growth planning, transparent performance review and reward processes that are gender neutral,
maternity and paternity leave, gender-inclusive workplace conditions with special attention given to the safety and
security of our women employees, 18-day annual paid leave, family health insurance. Husk does not believe in
micromanagement and encourages its employees to have a healthy work-life balance, giving them the freedom to
manage their workload to be compatible with their life.
Position objective:
The Program Manager role serves as a strategic and operational extension of the business head. This position acts as a
central coordinating point between the business head and all business units, ensuring smooth execution of key
programs, cross-functional alignment, and timely escalation of issues.
The role demands a highly versatile, analytical, and proactive individual capable of:
● Driving strategic project execution
● Monitoring cross-functional workstreams
● Enhancing operational efficiency
● Supporting innovation and transformation initiatives
● Ensuring visibility and accountability across teams reporting to the business head
The ideal candidate is detail-oriented, intellectually sharp, and able to thrive in a fast-paced environment with
minimal supervision.
Key Responsibilities Include:
1. Workstream Monitoring & Cross-Functional coordination
● Oversee, track, and coordinate workstreams across all teams reporting to the business head, ensuring
alignment with organizational goals.
● Act as the central support point for cross-functional collaboration, ensuring timely progress and issue
resolution.
● Maintain strong communication with functional leaders to gather updates, align priorities, and support
interdepartmental requirements.
2. Operational Efficiency & Process Implementation
● Lead the design, rollout, and monitoring of operational processes that enhance efficiency, consistency, and
productivity across teams.
● Identify opportunities for workflow optimization and standardization; develop improved systems and
practices.
● Ensure adoption and compliance across teams by providing clarity, training, and follow-up.
3. Performance Tracking & KPI Management
● Develop and maintain performance dashboards for all business head -reporting functions.
● Monitor KPIs, deliverables, milestones, and timelines to ensure accountability and operational clarity.
● Highlight performance gaps, risks, or delays and drive corrective actions in coordination with team leads.
● Provide structured weekly/monthly updates to the business head with actionable insights.
4. Support for Innovation & Strategic Initiatives
● Assist the business head in evaluating, coordinating, and executing strategic initiatives, both operational
and innovation-led.
● Support pilot programs, new process rollouts, and special projects by providing planning, execution
oversight, and documentation.
● Engage with cross-functional stakeholders for data gathering, alignment, and project implementation.
● Track initiative progress, identify dependencies, and ensure timely completion of activities.
5. Executive Support & Business Prioritization
● Assist the business head in planning priorities, preparing agendas, and maintaining structured follow-up on
key action items.
● Prepare high-quality reports, presentations, and briefs for internal and external stakeholders.
● Ensure that meetings, reviews, and discussions are supported with accurate data, analysis, and insights.
Requirements:
● Education: MBA from a top-tier institution. Bachelor's degree from a top tier institution is also mandatory.
● Experience:
o Minimum 3 years of experience in operations, program/project management, strategy, investor
relations, or a combination thereof.
o Exposure to high-growth startups or dynamic industries is a significant advantage.
● Skills & Abilities:
o Exceptional analytical and problem-solving skills, with the ability to manage and interpret complex
datasets.
o Advanced proficiency in Excel for data visualization and analysis.
o Excellent communication and presentation skills, with a proven track record of creating impactful
decks for senior leadership and board meetings.
o Demonstrated ability to manage multiple stakeholders and drive execution in fast-paced, high-
pressure environments.
o Strong process orientation and workflow management skills.
o Extremely bright and sharp, with the ability to handle complexity and maintain confidentiality.
o Willingness to handle both high-level strategic tasks and detailed administrative duties.
o Ability to handle multiple time zones with ease.
● Location - Mumbai (The role may require travel based on business needs)
Husk is an equal opportunity employer committed to diversity and inclusion and welcomes all applicants regardless
of age, disability, gender, marital status, pregnancy, race, or religion. Husk is committed to improving gender balance
within its teams worldwide. Female candidates are, therefore, highly encouraged to apply even if all requirements
are not met.
DISCLAIMER: This is an exhaustive list of all principal accountabilities, dimensions of the job, and person
specifications. While this is intended to be an accurate reflection of the current job, management reserves the right to
revise the job or to require that other or different tasks be performed when circumstances change (e.g. emergencies,
change in personnel, workload, technological developments, or organization developments).                          LATEX CODE TO UPDATE -\documentclass[a4paper,9.3pt]{article}
\usepackage{url}
\usepackage{parskip}
\usepackage[dvipsnames]{xcolor}
\usepackage[top=0.2in, bottom=0.14in, left=0.5in, right=0.5in]{geometry}
\usepackage{enumitem}
\usepackage{titlesec}
\usepackage{hyperref}
\usepackage{marvosym}
...
\definecolor{bodytext}{rgb}{0.10,0.10,0.10}
\definecolor{mutedtext}{rgb}{0.30,0.30,0.30}
\definecolor{datetext}{rgb}{0.40,0.40,0.40}
\definecolor{rulegray}{rgb}{0.55,0.55,0.55}
\hypersetup{colorlinks=true, urlcolor=black, linkcolor=black}
\titleformat{\section}{\fontsize{9.2}{11}\scshape\bfseries\color{black}\raggedright}{}{0em}{}[\color{rulegray}\titlerule]
\titlespacing{\section}{0pt}{14.5pt}{6pt}
\setlist[itemize]{noitemsep, topsep=4.8pt, leftmargin=1.2em, itemsep=5pt, parsep=0pt}
...
\begin{center}
{\LARGE\bfseries\color{black} Aditi Verma}

\vspace{3.5pt}
{\small\color{mutedtext} Research \& Analysis $\cdot$ Data-Driven Reporting $\cdot$ Cross-Functional Collaboration $\cdot$ Documentation \& Process Discipline $\cdot$ Fast Learner}

\vspace{3.5pt}
\small
\href{mailto:aditivermauk@gmail.com}{\Letter\ aditivermauk@gmail.com} $\;|\;$ \Mobilefone\ +91-8279524227 $\;|\;$ \Pointinghand\ Dehradun, India (open to relocation) $\;|\;$ \href{https://www.linkedin.com/in/aditi-verma-8b8220287/}{LinkedIn} $\;|\;$ \href{https://github.com/adjienjeknwc}{GitHub} $\;|\;$ \href{https://aditi-portfolio-topaz.vercel.app/}{Portfolio}
\end{center}
\vspace{4pt}

\section{Summary}
\small\color{bodytext}
Final-year B.Tech CSE student (CGPA 7.9/10), currently enrolled and actively pursuing my degree, with hands-on \textbf{research, data analysis, and documentation} experience from a live enterprise internship at EY. Independently designed, built, and shipped 4 end-to-end projects --- not coursework, but live systems solving real problems --- developing strong \textbf{analytical thinking, structured problem-solving, and cross-functional collaboration} skills along the way. Eager to bring this same curiosity and rigor to meaningful, real-world work in a mission-driven organization.

\section{Core Skills}
\small
\textbf{Research \& Analysis:} SQL and Python (Pandas, NumPy) for extracting and analyzing data; structured, hypothesis-driven approach to breaking down ambiguous problems into measurable pieces

\textbf{Data-Driven Reporting:} Built \textbf{dashboards and reports} translating raw data into actionable insights; Excel-based reporting used daily in a live internship role

\textbf{Cross-Functional Collaboration:} Worked directly with \textbf{business, product, and engineering teams} in a live enterprise internship; comfortable coordinating across departments to solve real problems

\textbf{Documentation \& Process Discipline:} Authored \textbf{functional specifications and technical documentation} bridging business requirements and execution; consistent, structured documentation habits across every project

\textbf{Technical Foundation:} JavaScript, Python, SQL, C; REST APIs, Git/GitHub version control; comfortable picking up new tools and technologies quickly in a fast-paced environment

\textbf{Communication:} Strong written and verbal communication; experience presenting findings and technical specs clearly to both technical and non-technical audiences

\section{Internship Experience}
\small
\textbf{Business Analyst Intern --- Insurance Domain} \hfill \textit{\color{datetext}May 2026 -- Jul 2026}\\
\textit{EY (Ernst \& Young Services Pvt. Ltd.)} \hfill \textit{\color{mutedtext}Mumbai, India}
\begin{itemize}
    \item Conducted \textbf{research} and gathered requirements for functional specifications, translating business needs into clear, structured documentation.
    \item Analyzed operational data using Excel and Python to identify trends and deliver \textbf{actionable insights} supporting real decision-making.
    \item \textbf{Collaborated with cross-functional teams} spanning business and engineering to support process improvements in a fast-paced enterprise environment.
    \item Participated in team meetings, contributing ideas and analysis to support project goals.
\end{itemize}

\section{Projects}
\small
\textbf{SmartSpend India --- Data Analytics Platform} \hfill \href{https://smartspend-india-fycu3h9ljwqxmxgn2wunwa.streamlit.app}{\small[Live]} \hspace{0.1em} {\fontsize{8.3}{10}\selectfont\color{mutedtext} Python, Pandas, NumPy, Plotly Express, Streamlit, SQLite3}
\begin{itemize}
  \item Conducted structured \textbf{research and data analysis} across a 10-city, 7-category dataset; designed the database schema and wrote SQL queries to define and track key metrics.
  \item Built interactive dashboards and reports to present findings clearly to stakeholders.
\end{itemize}
\textbf{Grid-Lock --- Real-Time EV Charging Platform} \hfill \href{https://grid-lock-vert.vercel.app}{\small[Live]} \hspace{0.1em} {\fontsize{8.3}{10}\selectfont\color{mutedtext} Node.js, Express.js, React.js, MongoDB, Socket.io, REST APIs}
\begin{itemize}
